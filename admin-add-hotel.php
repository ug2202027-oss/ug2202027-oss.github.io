...
<head>
    ...
    <title>Add Hotel - Admin - Bdhotels</title>
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 800px;">
                <form action="php/save-hotel.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" placeholder="e.g., Cox's Bazar, Dhaka" required>
                    </div>
